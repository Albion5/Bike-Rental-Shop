...
CREATE TABLE public.bikes (
    bike_id integer NOT NULL, type character varying(50) NOT NULL, size integer NOT NULL, available boolean DEFAULT true NOT NULL
);
...
CREATE SEQUENCE public.bikes_bike_id_seq AS integer START
WITH
...
CREATE TABLE public.customers (
    customer_id integer NOT NULL, phone character varying(15) NOT NULL, name character varying(40) NOT NULL
);
...
CREATE TABLE public.rentals (
    rental_id integer NOT NULL, customer_id integer NOT NULL, bike_id integer NOT NULL, date_rented date DEFAULT now() NOT NULL, date_returned date
);
...
CREATE SEQUENCE public.rentals_rental_id_seq AS integer START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
INSERT INTO public.customers VALUES (3, '777-7777', 'Alina');
...
INSERT INTO
    public.rentals
VALUES (
        5, 1, 5, '2021-05-27', '2024-03-29'
    );

INSERT INTO
    public.rentals
VALUES (
        4, 1, 4, '2021-05-27', '2024-03-29'
    );

INSERT INTO
    public.rentals
VALUES (
        1, 1, 1, '2021-05-25', '2024-03-29'
    );

INSERT INTO
    public.rentals
VALUES (
        2, 1, 2, '2021-05-25', '2024-03-29'
    );

INSERT INTO
    public.rentals
VALUES (
        3, 1, 3, '2021-05-27', '2024-03-29'
    );

INSERT INTO
    public.rentals
VALUES (
        6, 2, 6, '2021-05-27', '2024-03-29'
    );

INSERT INTO
    public.rentals
VALUES (
        7, 2, 7, '2021-05-27', '2024-03-29'
    );

INSERT INTO
    public.rentals
VALUES (
        8, 3, 9, '2024-03-29', '2024-03-29'
    );
...
SELECT pg_catalog.setval (
        'public.customers_customer_id_seq', 3, true
    );
